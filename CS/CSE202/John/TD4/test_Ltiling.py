...
def test1():
    ...
    if tmp != res:
            print("Your function middleL returned the wrong result ({} instead of {})".format(tmp, res))
            assert not grading_mode
...
def test2():
    ...
    res=(12,14)	
    if tmp != res:
            print("Your function lower_left_hole returned the wrong result ({} instead of {})".format(tmp, res))
            assert not grading_mode
    ...
    if tmp != res:
            print("Your function lower_left_hole returned the wrong result ({} instead of {})".format(tmp, res))
            assert not grading_mode
    print("++ Test success for lower_left_hole.")
    # lower_right_hole
    ...
    res=(15,9)
    if tmp != res:
            print("Your function lower_right_hole returned the wrong result ({} instead of {})".format(tmp, res))
            assert not grading_mode
            return
    ...
    if tmp != res:
            ...
            assert not grading_mode
            return
    print("++ Test success for lower_right_hole.")
    # upper_left_hole
    ...
    res=(6,18)
    if tmp != res:
            print("Your function upper_left_hole returned the wrong result ({} instead of {})".format(tmp, res))
            assert not grading_mode
            return
    ...
    if tmp != res:
            ...
            assert not grading_mode
            return
    print("++ Test success for upper_left_hole.")
    # upper_right_hole
    tmp=til.upper_right_hole(4,5,7,15,19)
    if tmp is None:
        print("skipping upper_right_hole (unimplemented)")
        assert not grading_mode
        return
    res=(15,19)
    if tmp != res:
            print("Your function upper_right_hole returned the wrong result ({} instead of {})".format(tmp, res))
            assert not grading_mode
            return
    ...
    if tmp != res:
            ...
            assert not grading_mode
            return
    print("++ Test success for upper_right_hole.")
