...
def test1():
    ...
    for prefix, wopt, solution in [(['A','F','G'], 14, ['A', 'F', 'G', 'D', 'E', 'B', 'C', 'H', 'A']),
        ...
        res=wg.min_cycle_aux(0,prefix,set(['A', 'B','C','D','E','F','G','H'])-set(prefix))
        if res is None:
...
def read_cities():
    cities=["Barcelona","Belgrade","Berlin","Brussels","Bucharest","Budapest","Copenhagen","Dublin",
            ...
            "Rome","Saint Petersbourg", "Sofia", "Stockholm", "Vienna", "Warsaw"]
    distances=[]
